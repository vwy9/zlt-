...
from v2_code.signals_class import Signalscalculate


class IndexBacktest:
    def __init__(self, weight_data, signals, initial_investment_weight, benchmark, rf_rate=0.04, trade_tax=0.0003,
                 stamp_tax=0.0005, ):
    ...
    def generate_portfolio(self):
        ...
        self.results.pd.concat(portfolio_return)
    ...
    def inday_plot_cumulative_returns(self, date):
...
if __name__ == "__main__":
    ...
    signals = Signalscalculate.linear_full_signals(initial_investment_weight)
    for date in trading_date:
        ...
        backtest = IndexBacktest(weight_data, signals, initial_investment_weight, benchmark_value)
        ...
        # 当日的所有行情数据自动生成html画图
        datar, datarm, signals = backtest.inday_plot_cumulative_returns(date)
