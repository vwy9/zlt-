...
def mdd_and_alldayplt(df1, df2, df3, df4, metrics):
    ...
    # 渲染图表到文件
    grid_chart.render("123_combined_chart.html")
    ...
    chart_html_filename = "123_combined_chart.html"
    # 读取图表的HTML内容
